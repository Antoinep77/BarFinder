        ...
        return (
            ...
            <form className="form-inline" onSubmit={e => this.onSubmit(e)}>
                ...
                <div className="form-check animals">
                    ...
                    <label><input type="radio" name="animal" value="1951430" onChange={e => this.onChangeRadio(e)}/><img src='logos/noun_Animal_1951430.png'></img></label>
                    <label><input type="radio" name="animal" value="1951432" onChange={e => this.onChangeRadio(e)}/><img src='logos/noun_Animal_1951432.png'></img></label>
                    <label><input type="radio" name="animal" value="1951448" onChange={e => this.onChangeRadio(e)}/><img src='logos/noun_Animal_1951448.png'></img></label>
                    <label><input type="radio" name="animal" value="1951449" onChange={e => this.onChangeRadio(e)}/><img src='logos/noun_Animal_1951449.png'></img></label>
                    <label><input type="radio" name="animal" value="1951454" onChange={e => this.onChangeRadio(e)}/><img src='logos/noun_Animal_1951454.png'></img></label>
                    <label><input type="radio" name="animal" value="1951456" onChange={e => this.onChangeRadio(e)}/><img src='logos/noun_Animal_1951456.png'></img></label>
